...
## 링크
* [setup.exe 파일 다운받기](https://google.com](https://github.com/azusa0999/ClipboardEnterRemover/releases/download/v1.0.0/Release.zip, "setup.exe 파일")
* [실행파일 다운받기](https://github.com/azusa0999/ClipboardEnterRemover/tree/main/bin/Release/net6.0-windows,"실행파일") (모든 파일을 다운로드 받고 실행하시면 됩니다) :
